                    ...
                    <div onClick={onShowCharsPanel} className="flex-1 min-w-0 flex items-center gap-3 cursor-pointer">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {/* Token 脱离状态行文档流，数字变长/显示隐藏都不能把顶栏撑高。 */}
                                {lastTokenUsage && (
                                    <div className="pointer-events-none absolute right-12 top-[58%] z-[65] whitespace-nowrap">
                                        <div className="text-[9px] px-1.5 py-0.5 bg-slate-100/95 text-slate-400 rounded-md font-mono border border-slate-200" title={tokenBreakdown ? `prompt: ${tokenBreakdown.prompt} | completion: ${tokenBreakdown.completion} | msgs: ${tokenBreakdown.msgCount} | pass: ${tokenBreakdown.pass}` : ''}>
                                            {lastTokenUsage}
                                        </div>
                                    </div>
                                )}
