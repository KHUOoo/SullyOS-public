        ...
        <div className="space-y-4">
            ...
            <div>
                ...
                <div className="mt-1.5 text-[10px] leading-relaxed text-slate-400">
                    可用选择器：<code className="rounded bg-slate-100 px-1 text-slate-500">.sully-chat-header / -avatar / -name / -online-status / -model / -buffs / -token / -trigger / -back / -status / -inputbar / -actions-button / -voice-button / -emoji-button / -send-button / -panel / -root</code>
                </div>
